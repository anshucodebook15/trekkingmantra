      ...
      <div className="container mx-auto font-poppins">
        ...
        <div className="typography_box border-1 border-gray-400/40 p-10 w-[70%] min-h-[90vh] mx-auto mt-10">
          ...
          <p className="text-[16px]/[1.6] text-gray-800 mb-2 ">
            Experience the best of Europe’s history and natural beauty with
            Italy and Switzerland tour packages, blending Italy’s iconic cities
            with Switzerland’s scenic Alps.
          </p>
